...
import { Text, Group, Button, Stack, Switch, NumberInput, Loader, Card, Badge, Grid, Paper, Avatar, ThemeIcon, Center } from "@mantine/core";
    ...
    <div className={styles.workspacePanel} style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "16px", minHeight: "100%" }}>
        ...
        <Grid gutter="md">
            ...
            <Grid.Col span={{ base: 12, lg: 6 }}>
                <Paper p="md" radius="md" style={{ backgroundColor: "rgba(20, 17, 15, 0.4)", border: "1px solid rgba(255,255,255,0.04)", minHeight: "65vh" }}>
            ...
            <Grid.Col span={{ base: 12, lg: 6 }}>
                <Paper p="md" radius="md" style={{ backgroundColor: "rgba(20, 17, 15, 0.4)", border: "1px solid rgba(255,255,255,0.04)" }}>
                    <Text size="lg" fw={700} c="white" mb="md" style={{ letterSpacing: 0.5 }}>
                        Register & Stock
                    </Text>
